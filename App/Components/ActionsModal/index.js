            ...
            <View style={styles.content}>
              <View style={styles.wrapper}>
                <Item
                  ...
                  text={Languages.openInSafari}
                  onPress={this.openInSafari}
                />
                <Item
                  icon={Images.ShareIcon}
                  text={Languages.sharing}
                  onPress={this.share}
                />
                <Item
                  icon={Images.FavoriteIcon}
                  text={Languages.saveToWishlist}
                  onPress={this.saveToWishlist}
                />
                <Item
                  icon={Images.CopyIcon}
                  text={Languages.copyLink}
                  onPress={this.copyLink}
                />
                <Item
                  icon={Images.AddCommentIcon}
                  text={Languages.addComment}
