...
import _PostNews from './PostNews';
import _PostNewsContent from './PostNewsContent';
import _NewCategory from './NewCategory';
...
export const PostNews = _PostNews;
export const PostNewsContent = _PostNewsContent;
export const NewCategory = _NewCategory;
